...
//		});
		...
		text = String.format("<h2>How can I move between views? </h2><br></br><p> rom any view, open a menu with navigation options by clicking the on the three dots on the bottom right of your screen.</p>");
		styledText = Html.fromHtml(text);
		tv.setText(styledText);
		...
		text = String.format("<h2>Why aren’t the classes from List view also in Explore View?</h2><br></br><p>Explore view is meant for more flexible adding and removing classes, and so does not automatically sync with List view. In order to load your classes from List into Explore view, open the options menu and select \"Reset”. In order to save your classes from Explore view to List view, select \"Save” on the options menu.</p>");
		styledText = Html.fromHtml(text);
		tv.setText(styledText);
		
		tv = (TextView) findViewById(R.id.tv9);
		text = String.format("<h2>How do I remove classes that I have chosen?</h2><br></br><p> From List view, click and hold the class you want to remove. From the context menu that opens, select \"Remove” or \"Replace”. Alternatively, remove the class from Explore view and save your selections via options menu. </p>");
		styledText = Html.fromHtml(text);
		tv.setText(styledText);
		...
		panel3.setOnExpandListener(new ExpandablePanel.OnExpandListener() {
		    public void onCollapse(View handle, View content) {
		        Button btn = (Button)handle;
		        btn.setText("More");
		    }
		...
		panel4.setOnExpandListener(new ExpandablePanel.OnExpandListener() {
		    public void onCollapse(View handle, View content) {
		        Button btn = (Button)handle;
		        btn.setText("More");
		    }
		...
		panel5.setOnExpandListener(new ExpandablePanel.OnExpandListener() {
		    public void onCollapse(View handle, View content) {
		        Button btn = (Button)handle;
		        btn.setText("More");
		    }
		...
		panel6.setOnExpandListener(new ExpandablePanel.OnExpandListener() {
		    public void onCollapse(View handle, View content) {
		        Button btn = (Button)handle;
		        btn.setText("More");
		    }
		...
		panel7.setOnExpandListener(new ExpandablePanel.OnExpandListener() {
		    public void onCollapse(View handle, View content) {
		        Button btn = (Button)handle;
		        btn.setText("More");
		    }
		...
		panel8.setOnExpandListener(new ExpandablePanel.OnExpandListener() {
		    public void onCollapse(View handle, View content) {
		        Button btn = (Button)handle;
		        btn.setText("More");
		    }
		...
		panel9.setOnExpandListener(new ExpandablePanel.OnExpandListener() {
		    public void onCollapse(View handle, View content) {
		        Button btn = (Button)handle;
		        btn.setText("More");
		    }
		...
		ExpandablePanel panel10 = (ExpandablePanel) findViewById(R.id.ep10);
		panel10.setOnExpandListener(new ExpandablePanel.OnExpandListener() {
		    public void onCollapse(View handle, View content) {
		        Button btn = (Button)handle;
		        btn.setText("More");
		    }
